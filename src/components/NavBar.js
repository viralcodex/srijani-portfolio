      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="dark:border-white border-2 min-w-[70vw] flex flex-col justify-between items-center fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-30 bg-dark/90 dark:bg-light/75 rounded-lg backdrop-blur-md py-32"
          >
